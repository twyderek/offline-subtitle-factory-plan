...
- 發布狀態：本機正式候選已完成；GitHub commit／tag／Release／遠端下載核對於本條目結案後補記。Windows EXE `Get-AuthenticodeSignature` 為 `NotSigned`，適用常設授權 `AUTH-2026-07-23-01`；SmartScreen／Unknown Publisher 風險保留。
