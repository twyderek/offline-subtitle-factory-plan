...
- Windows preview workflow 已移至 repository root `.github/workflows/windows-preview.yml`，仍以 `app` 為工作目錄，CI 狀態為 `CI=PENDING`；待 push 後由 GitHub Actions 實際產生 run 再更新結論。
